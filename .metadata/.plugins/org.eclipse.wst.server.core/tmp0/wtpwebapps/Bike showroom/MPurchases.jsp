...
<h2 align=center> Monthly Purchases List</h2>
<form name=cons>
...
<!--	<DIV STYLE="overflow:scroll;width:650px; height:400px;">-->
	...
	<tr class=row_title>
        <th class=row_title><a class=title href="MPurchases.jsp?orderby=ProdID">ProdID</a></th>
	<th class=row_title><a class=title href="MPurchases.jsp?orderby=Stock">Stock</a></th>
	<th class=row_title><a class=title href="MPurchases.jsp?orderby=BillAmmount">BillAmmount</a></th>
<%
int DisRow=0;
